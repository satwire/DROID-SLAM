...
def compute_preconditioner(
    ...
    if False:
        ...
        C_0_viz = cv2.resize(C_0_viz, (C_0_viz.shape[-1] * 8, C_0_viz.shape[-2] * 8))
...
def precond_BA(
    ...
    # align estimated disparity with mono-disparity with precomputed scale
    ...
    for itr in range(iterations):
        ...
        # if precondition:
        #     # multiply with precondion matrix
        #     Ji = Ji @ P_inv_pose_ii
        #     Jj = Jj @ P_inv_pose_jj
        #     Jz = Jz * P_inv_disp_ii
