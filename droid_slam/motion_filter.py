...
class MotionFilter:
    ...
    def __init__(self, net, video, thresh=2.5, device="cuda:0", timing=None):
        # split net modules
        self.cnet = net.cnet
        self.fnet = net.fnet
...
#             self.net, self.inp, self.fmap = net, inp, gmap
#             self.video.append(
#                 tstamp, image, Id, 1.0, intrinsics / 8.0, gmap[0], net[0], inp[0]
#             )
...
#                 self.net, self.inp, self.fmap = net, inp, gmap
#                 self.video.append(
#                     tstamp, image, None, None, intrinsics / 8.0, gmap[0], net[0], inp[0]
#                 )
